...
class _AppService implements AppService {
  ...
  Future<HttpResponse<AboutUsResponse>> getAbout() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<HttpResponse<AboutUsResponse>>(
        Options(method: 'GET', headers: _headers, extra: _extra)
            .compose(_dio.options, 'pages/about', queryParameters: queryParameters, data: _data)
  ...
  Future<HttpResponse<TermsResponse>> getTermsAndConditions() async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<HttpResponse<TermsResponse>>(
        Options(method: 'GET', headers: _headers, extra: _extra)
            .compose(_dio.options, 'pages/terms', queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
