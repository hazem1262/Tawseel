...
_$_PlaceAddressDetails _$$_PlaceAddressDetailsFromJson(
...
Map<String, dynamic> _$$_PlaceAddressDetailsToJson(
...
_$_AddressGeometry _$$_AddressGeometryFromJson(Map<String, dynamic> json) =>
    _$_AddressGeometry(
      AddressLocation.fromJson(json['location'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$_AddressGeometryToJson(_$_AddressGeometry instance) =>
    <String, dynamic>{
      'location': instance.location,
    };

_$_AddressLocation _$$_AddressLocationFromJson(Map<String, dynamic> json) =>
    _$_AddressLocation(
      (json['lat'] as num).toDouble(),
      (json['lng'] as num).toDouble(),
    );

Map<String, dynamic> _$$_AddressLocationToJson(_$_AddressLocation instance) =>
    <String, dynamic>{
      'lat': instance.lat,
      'lng': instance.lng,
    };
