...
class PlaceAddressDetails with _$PlaceAddressDetails {
  const factory PlaceAddressDetails(List<AddressItem> results) =
      _PlaceAddressDetails;
  factory PlaceAddressDetails.fromJson(Map<String, dynamic> json) =>
      _$PlaceAddressDetailsFromJson(json);
}
