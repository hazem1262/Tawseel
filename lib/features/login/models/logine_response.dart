...
class LoginDataItem with _$LoginDataItem {
  const factory LoginDataItem(UserItem user, String? access_token, String? token_type) = _LoginDataItem;
  factory LoginDataItem.fromJson(Map<String, dynamic> json) => _$LoginDataItemFromJson(json);
}
