...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => LoginBloc(ServicesLocator.loginRepository),
      child: Scaffold(
  ...
  void doLoginByPhone(BuildContext context) {
    ...
    if (isFormValid()) {
      ...
      BlocProvider.of<LoginBloc>(context).add(LoginEvent.loginWithPhone(
          phoneController.text, passwordController.text));
    } else
      debugPrint("form is not valid");

    context.navigateToWithParams(
        screen: OtpScreen(otp: "otp tesssssst param"),
        screenConfig: OtpScreenConfig);
  }
