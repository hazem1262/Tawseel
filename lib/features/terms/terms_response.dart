...
abstract class TermsData implements _$TermsData {
  factory TermsData(int id, String? title, String? slug, String? content) = _TermsData;
  factory TermsData.fromJson(Map<String, dynamic> json) => _$TermsDataFromJson(json);
}
