...
class AppRouter extends _i24.RootStackRouter {
    ...
    SearchScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(
        ...
        child: _i17.SearchScreen(
          key: args.key,
          outSideFilterDate: args.outSideFilterDate,
        ),
      );
    },
  ...
  List<_i24.RouteConfig> get routes => [
        ...
        _i24.RouteConfig(
          LocationPickerDialogRoute.name,
          path: '/location-picker-dialog',
        ),
        _i24.RouteConfig(
          AddressDetailsScreenRoute.name,
          path: '/address-details-screen',
        ),
        _i24.RouteConfig(
          SendPhoneScreenRoute.name,
...
class OtpScreenRoute extends _i24.PageRouteInfo<OtpScreenRouteArgs> {
  OtpScreenRoute({
    _i26.Key? key,
    required _i27.OTP_TYPE otpType,
...
class SendPhoneScreenRouteArgs {
  const SendPhoneScreenRouteArgs({
    this.key,
...
class AboutUsScreenRoute extends _i24.PageRouteInfo<AboutUsScreenRouteArgs> {
  AboutUsScreenRoute({_i26.Key? key})
      : super(
          AboutUsScreenRoute.name,
          path: '/about-us-screen',
          args: AboutUsScreenRouteArgs(key: key),
        );
...
class SearchScreenRoute extends _i24.PageRouteInfo<SearchScreenRouteArgs> {
  SearchScreenRoute({
    _i26.Key? key,
    _i29.FilterDate? outSideFilterDate,
  }) : super(
          SearchScreenRoute.name,
          path: '/search-screen',
          args: SearchScreenRouteArgs(
            key: key,
            outSideFilterDate: outSideFilterDate,
          ),
        );
...
class OffersScreenRoute extends _i24.PageRouteInfo<OffersScreenRouteArgs> {
  OffersScreenRoute({_i26.Key? key})
      : super(
          OffersScreenRoute.name,
          path: 'offers-screen',
          args: OffersScreenRouteArgs(key: key),
        );
