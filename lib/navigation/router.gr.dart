...
class AppRouter extends _i24.RootStackRouter {
  ...
  final Map<String, _i24.PageFactory> pagesMap = {
    SplashScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i1.SplashScreen(key: args.key));
    },
    LandingScreenRoute.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i2.LandingScreen());
    },
    LoginScreenRoute.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: const _i3.LoginScreen());
    },
    SignUpScreenRoute.name: (routeData) {
      final args = routeData.argsAs<SignUpScreenRouteArgs>(orElse: () => const SignUpScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i4.SignUpScreen(key: args.key));
    },
    OtpScreenRoute.name: (routeData) {
      final args = routeData.argsAs<OtpScreenRouteArgs>();
      return _i24.MaterialPageX<dynamic>(
          routeData: routeData, child: _i5.OtpScreen(key: args.key, otpType: args.otpType, phone: args.phone));
    },
    MainScreenRoute.name: (routeData) {
      final args = routeData.argsAs<MainScreenRouteArgs>(orElse: () => const MainScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i6.MainScreen(key: args.key));
    },
    EditProfileScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i7.EditProfileScreen(key: args.key));
    },
    LocationPickerDialogRoute.name: (routeData) {
      final args = routeData.argsAs<LocationPickerDialogRouteArgs>();
      return _i24.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i8.LocationPickerDialog(key: args.key, oppenedFromMyAddresses: args.oppenedFromMyAddresses));
    },
    AddressDetailsScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(
          ...
          child: _i9.AddressDetailsScreen(
              key: args.key, pickedLocation: args.pickedLocation, oppenedFromMyAddresses: args.oppenedFromMyAddresses));
    },
    SendPhoneScreenRoute.name: (routeData) {
      final args = routeData.argsAs<SendPhoneScreenRouteArgs>();
      return _i24.MaterialPageX<dynamic>(
          routeData: routeData, child: _i10.SendPhoneScreen(key: args.key, intention: args.intention));
    },
    ChangePasswordScreenRoute.name: (routeData) {
      final args = routeData.argsAs<ChangePasswordScreenRouteArgs>();
      return _i24.MaterialPageX<dynamic>(
          routeData: routeData, child: _i11.ChangePasswordScreen(key: args.key, intention: args.intention));
    },
    SupportScreenRoute.name: (routeData) {
      final args = routeData.argsAs<SupportScreenRouteArgs>(orElse: () => const SupportScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i12.SupportScreen(key: args.key));
    },
    MyAddressesScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i13.MyAddressesScreen(key: args.key));
    },
    CategoryDetailsScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(
          routeData: routeData,
          child:
              _i14.CategoryDetailsScreen(key: args.key, categoryId: args.categoryId, categoryName: args.categoryName));
    },
    TermsAndConditionsScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i15.TermsAndConditionsScreen(key: args.key));
    },
    AboutUsScreenRoute.name: (routeData) {
      final args = routeData.argsAs<AboutUsScreenRouteArgs>(orElse: () => const AboutUsScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i16.AboutUsScreen(key: args.key));
    },
    SearchScreenRoute.name: (routeData) {
      final args = routeData.argsAs<SearchScreenRouteArgs>(orElse: () => const SearchScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(
          routeData: routeData, child: _i17.SearchScreen(key: args.key, outSideFilterDate: args.outSideFilterDate));
    },
    ...
    HomeScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i20.HomeScreen(key: args.key));
    },
    OffersScreenRoute.name: (routeData) {
      final args = routeData.argsAs<OffersScreenRouteArgs>(orElse: () => const OffersScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i21.OffersScreen(key: args.key));
    },
    FavoritesScreenRoute.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i22.FavoritesScreen(key: args.key));
    },
    ProfileScreenRoute.name: (routeData) {
      final args = routeData.argsAs<ProfileScreenRouteArgs>(orElse: () => const ProfileScreenRouteArgs());
      return _i24.MaterialPageX<dynamic>(routeData: routeData, child: _i23.ProfileScreen(key: args.key));
    }
  };
  ...
  List<_i24.RouteConfig> get routes => [
        ...
        _i24.RouteConfig(MainScreenRoute.name, path: '/main-screen', children: [
          _i24.RouteConfig(HomeScreenRoute.name, path: '', parent: MainScreenRoute.name),
          _i24.RouteConfig(OffersScreenRoute.name, path: 'offers-screen', parent: MainScreenRoute.name),
          _i24.RouteConfig(FavoritesScreenRoute.name, path: 'favorites-screen', parent: MainScreenRoute.name),
          _i24.RouteConfig(ProfileScreenRoute.name, path: 'profile-screen', parent: MainScreenRoute.name)
        ]),
        _i24.RouteConfig(EditProfileScreenRoute.name, path: '/edit-profile-screen'),
        _i24.RouteConfig(LocationPickerDialogRoute.name, path: '/location-picker-dialog'),
        _i24.RouteConfig(AddressDetailsScreenRoute.name, path: '/address-details-screen'),
        _i24.RouteConfig(SendPhoneScreenRoute.name, path: '/send-phone-screen'),
        _i24.RouteConfig(ChangePasswordScreenRoute.name, path: '/change-password-screen'),
        _i24.RouteConfig(SupportScreenRoute.name, path: '/support-screen'),
        _i24.RouteConfig(MyAddressesScreenRoute.name, path: '/my-addresses-screen'),
        _i24.RouteConfig(CategoryDetailsScreenRoute.name, path: '/category-details-screen'),
        _i24.RouteConfig(TermsAndConditionsScreenRoute.name, path: '/terms-and-conditions-screen'),
        _i24.RouteConfig(AboutUsScreenRoute.name, path: '/about-us-screen'),
        _i24.RouteConfig(SearchScreenRoute.name, path: '/search-screen'),
        _i24.RouteConfig(ViewAllMarketPlacesRoute.name, path: '/view-all-market-places'),
...
class SplashScreenRoute extends _i24.PageRouteInfo<SplashScreenRouteArgs> {
  SplashScreenRoute({_i26.Key? key}) : super(SplashScreenRoute.name, path: '/', args: SplashScreenRouteArgs(key: key));
...
class LandingScreenRoute extends _i24.PageRouteInfo<void> {
  const LandingScreenRoute() : super(LandingScreenRoute.name, path: '/landing-screen');
...
class LoginScreenRoute extends _i24.PageRouteInfo<void> {
  const LoginScreenRoute() : super(LoginScreenRoute.name, path: '/login-screen');
...
class SignUpScreenRoute extends _i24.PageRouteInfo<SignUpScreenRouteArgs> {
  SignUpScreenRoute({_i26.Key? key})
      : super(SignUpScreenRoute.name, path: '/sign-up-screen', args: SignUpScreenRouteArgs(key: key));
...
class OtpScreenRoute extends _i24.PageRouteInfo<OtpScreenRouteArgs> {
  OtpScreenRoute({_i26.Key? key, required _i27.OTP_TYPE otpType, required String phone})
      : super(OtpScreenRoute.name,
            path: '/otp-screen', args: OtpScreenRouteArgs(key: key, otpType: otpType, phone: phone));

  static const String name = 'OtpScreenRoute';
}

class OtpScreenRouteArgs {
  const OtpScreenRouteArgs({this.key, required this.otpType, required this.phone});
...
class MainScreenRoute extends _i24.PageRouteInfo<MainScreenRouteArgs> {
  MainScreenRoute({_i26.Key? key, List<_i24.PageRouteInfo>? children})
      : super(MainScreenRoute.name,
            path: '/main-screen', args: MainScreenRouteArgs(key: key), initialChildren: children);
...
class EditProfileScreenRoute extends _i24.PageRouteInfo<EditProfileScreenRouteArgs> {
  EditProfileScreenRoute({_i26.Key? key})
      : super(EditProfileScreenRoute.name, path: '/edit-profile-screen', args: EditProfileScreenRouteArgs(key: key));
...
class LocationPickerDialogRoute extends _i24.PageRouteInfo<LocationPickerDialogRouteArgs> {
  LocationPickerDialogRoute({_i26.Key? key, required bool oppenedFromMyAddresses})
      : super(LocationPickerDialogRoute.name,
            path: '/location-picker-dialog',
            args: LocationPickerDialogRouteArgs(key: key, oppenedFromMyAddresses: oppenedFromMyAddresses));

  static const String name = 'LocationPickerDialogRoute';
}

class LocationPickerDialogRouteArgs {
  const LocationPickerDialogRouteArgs({this.key, required this.oppenedFromMyAddresses});
...
class AddressDetailsScreenRoute extends _i24.PageRouteInfo<AddressDetailsScreenRouteArgs> {
  AddressDetailsScreenRoute(
      {_i26.Key? key, required _i28.UserPickedLocation pickedLocation, required bool oppenedFromMyAddresses})
      : super(AddressDetailsScreenRoute.name,
            path: '/address-details-screen',
            args: AddressDetailsScreenRouteArgs(
                key: key, pickedLocation: pickedLocation, oppenedFromMyAddresses: oppenedFromMyAddresses));

  static const String name = 'AddressDetailsScreenRoute';
}

class AddressDetailsScreenRouteArgs {
  const AddressDetailsScreenRouteArgs({this.key, required this.pickedLocation, required this.oppenedFromMyAddresses});
...
class SendPhoneScreenRoute extends _i24.PageRouteInfo<SendPhoneScreenRouteArgs> {
  SendPhoneScreenRoute({_i26.Key? key, required _i10.Intention intention})
      : super(SendPhoneScreenRoute.name,
            path: '/send-phone-screen', args: SendPhoneScreenRouteArgs(key: key, intention: intention));
...
class ChangePasswordScreenRoute extends _i24.PageRouteInfo<ChangePasswordScreenRouteArgs> {
  ChangePasswordScreenRoute({_i26.Key? key, required _i11.ChangePasswordIntention intention})
      : super(ChangePasswordScreenRoute.name,
            path: '/change-password-screen', args: ChangePasswordScreenRouteArgs(key: key, intention: intention));
...
class SupportScreenRoute extends _i24.PageRouteInfo<SupportScreenRouteArgs> {
  SupportScreenRoute({_i26.Key? key})
      : super(SupportScreenRoute.name, path: '/support-screen', args: SupportScreenRouteArgs(key: key));
...
class MyAddressesScreenRoute extends _i24.PageRouteInfo<MyAddressesScreenRouteArgs> {
  MyAddressesScreenRoute({_i26.Key? key})
      : super(MyAddressesScreenRoute.name, path: '/my-addresses-screen', args: MyAddressesScreenRouteArgs(key: key));
...
class CategoryDetailsScreenRoute extends _i24.PageRouteInfo<CategoryDetailsScreenRouteArgs> {
  CategoryDetailsScreenRoute({_i26.Key? key, required int categoryId, required String categoryName})
      : super(CategoryDetailsScreenRoute.name,
            path: '/category-details-screen',
            args: CategoryDetailsScreenRouteArgs(key: key, categoryId: categoryId, categoryName: categoryName));

  static const String name = 'CategoryDetailsScreenRoute';
}

class CategoryDetailsScreenRouteArgs {
  const CategoryDetailsScreenRouteArgs({this.key, required this.categoryId, required this.categoryName});
...
class TermsAndConditionsScreenRoute extends _i24.PageRouteInfo<TermsAndConditionsScreenRouteArgs> {
  TermsAndConditionsScreenRoute({_i26.Key? key})
      : super(TermsAndConditionsScreenRoute.name,
            path: '/terms-and-conditions-screen', args: TermsAndConditionsScreenRouteArgs(key: key));
...
class AboutUsScreenRoute extends _i24.PageRouteInfo<AboutUsScreenRouteArgs> {
  AboutUsScreenRoute({_i26.Key? key})
      : super(AboutUsScreenRoute.name, path: '/about-us-screen', args: AboutUsScreenRouteArgs(key: key));
...
class SearchScreenRoute extends _i24.PageRouteInfo<SearchScreenRouteArgs> {
  SearchScreenRoute({_i26.Key? key, _i29.FilterDate? outSideFilterDate})
      : super(SearchScreenRoute.name,
            path: '/search-screen', args: SearchScreenRouteArgs(key: key, outSideFilterDate: outSideFilterDate));
...
class ViewAllMarketPlacesRoute extends _i24.PageRouteInfo<ViewAllMarketPlacesRouteArgs> {
  ViewAllMarketPlacesRoute({int? categoryId, String? categoryName, int? subCategoryId, String? subCategoryName})
...
class ViewAllMarketPlacesRouteArgs {
  const ViewAllMarketPlacesRouteArgs({this.categoryId, this.categoryName, this.subCategoryId, this.subCategoryName});
  ...
  FilterScreenRoute(
      ...
      : super(FilterScreenRoute.name,
            ...
            args: FilterScreenRouteArgs(
                key: key, onApplyFilter: onApplyFilter, onResetFilter: onResetFilter, filterDate: filterDate));
...
class FilterScreenRouteArgs {
  const FilterScreenRouteArgs(
      {this.key, required this.onApplyFilter, required this.onResetFilter, required this.filterDate});
...
class HomeScreenRoute extends _i24.PageRouteInfo<HomeScreenRouteArgs> {
  HomeScreenRoute({_i26.Key? key}) : super(HomeScreenRoute.name, path: '', args: HomeScreenRouteArgs(key: key));
...
class OffersScreenRoute extends _i24.PageRouteInfo<OffersScreenRouteArgs> {
  OffersScreenRoute({_i26.Key? key})
      : super(OffersScreenRoute.name, path: 'offers-screen', args: OffersScreenRouteArgs(key: key));
...
class FavoritesScreenRoute extends _i24.PageRouteInfo<FavoritesScreenRouteArgs> {
  FavoritesScreenRoute({_i26.Key? key})
      : super(FavoritesScreenRoute.name, path: 'favorites-screen', args: FavoritesScreenRouteArgs(key: key));
...
class ProfileScreenRoute extends _i24.PageRouteInfo<ProfileScreenRouteArgs> {
  ProfileScreenRoute({_i26.Key? key})
      : super(ProfileScreenRoute.name, path: 'profile-screen', args: ProfileScreenRouteArgs(key: key));
