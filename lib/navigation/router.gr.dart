...
import '../features/address/my_addresses/MyAddressesScreen.dart' as _i15;
...
import '../features/mainScreen/bottomTabs/favorites/FavoritesScreen.dart'
    as _i18;
import '../features/mainScreen/bottomTabs/home/HomeScreen.dart' as _i16;
import '../features/mainScreen/bottomTabs/offers/OffersScreen.dart' as _i17;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    LocationPickerDialogRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i10.LocationPickerDialog(
              key: args.key,
    ...
    MyAddressesScreenRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (data) {
          final args = data.argsAs<MyAddressesScreenRouteArgs>(
              orElse: () => const MyAddressesScreenRouteArgs());
          return _i15.MyAddressesScreen(key: args.key);
        }),
    ...
    OffersScreenRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i17.OffersScreen(key: args.key);
        }),
    FavoritesScreenRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i18.FavoritesScreen(key: args.key);
        }),
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(MyAddressesScreenRoute.name,
...
class MainScreenRoute extends _i1.PageRouteInfo<MainScreenRouteArgs> {
  MainScreenRoute({_i20.Key? key, List<_i1.PageRouteInfo>? children})
      : super(name,
            path: '/main-screen',
...
class SendPhoneScreenRoute extends _i1.PageRouteInfo<SendPhoneScreenRouteArgs> {
  SendPhoneScreenRoute({_i20.Key? key, required _i12.Intention intention})
      : super(name,
...
class ChangePasswordScreenRoute
  ...
  ChangePasswordScreenRoute(
      {_i20.Key? key, required _i13.ChangePasswordIntention intention})
      : super(name,
            path: '/change-password-screen',
            args:
...
class MyAddressesScreenRoute
    extends _i1.PageRouteInfo<MyAddressesScreenRouteArgs> {
